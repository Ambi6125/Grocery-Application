...
{
    public class Cart : IEnumerable<OrderItem>, ICollection<OrderItem>, IReadOnlyCollection<OrderItem>
    {
        ...
        public Cart(int id, Account placer, ICollection<OrderItem> items)
        {
            this.id = id;
    ...
    public class CartEnumerator : IEnumerator<OrderItem>
    {
        ...
        public CartEnumerator(IEnumerable<OrderItem> enumeration)
        {
